...
export function ModelsPage({ models, selectedModel, modelMode, harnessModels, harnessSettings, harnessEditorModule, harnessModelDraft, harnessApiKeyVisible, setHarnessApiKeyVisible, setHarnessModelDraft, harnessTestState, harnessTestResult, testHarnessModelConfig, modelEditorOpen, modelDraft, setModelDraft, modelApiKeyVisible, setModelApiKeyVisible, modelTestState, modelTestResult, testModelConfig, openNewModel, openEditModel, saveModel, selectModel, deleteModel, closeModelEditor, changeModelMode, openHarnessModelEditor, closeHarnessModelEditor, saveHarnessModel, saveHarnessSettings, deleteHarnessModel, isChatActive, t }) {
  ...
  return <section className="models-page" aria-labelledby="models-title">
    ...
    {modelMode === 'harness' ? <section className="model-mode-panel">
      ...
      {modelEditorOpen && <div className="model-page-editor"><ModelEditor draft={modelDraft} setDraft={setModelDraft} apiKeyVisible={modelApiKeyVisible} setApiKeyVisible={setModelApiKeyVisible} testState={modelTestState} testResult={modelTestResult} onSave={saveModel} onTest={testModelConfig} onCancel={closeModelEditor} t={t} /></div>}
