...
contextBridge.exposeInMainWorld('cosight', {
  ...
  reindexRoleKnowledge: (roleInput) => ipcRenderer.invoke('roles:reindex-knowledge', roleInput),
  discardRoleKnowledgeBuild: (payload) => ipcRenderer.invoke('roles:discard-knowledge-build', payload),
  ...
  testModel: (model, requestId) => ipcRenderer.invoke('settings:test-model', model, requestId),
  cancelModelTest: (requestId) => ipcRenderer.send('settings:cancel-model-test', requestId),
  ...
  testHarnessModel: (model, requestId) => ipcRenderer.invoke('settings:test-harness-model', model, requestId),
